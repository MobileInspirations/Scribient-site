...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    socialLinks: Schema.Attribute.Component<'navigation.link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLeadSubmissionLeadSubmission
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentEhr: Schema.Attribute.String;
    ...
    practiceName: Schema.Attribute.String & Schema.Attribute.Required;
    practiceType: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pageKind: Schema.Attribute.Enumeration<
      ['home', 'standard', 'legal', 'seo-landing']
    > &
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    announcementBar: Schema.Attribute.Component<'navigation.link', false>;
    appUrl: Schema.Attribute.String & Schema.Attribute.Required;
    brandName: Schema.Attribute.String & Schema.Attribute.Required;
    businessContact: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    navigation: Schema.Attribute.Component<'navigation.link', true>;
    publishedAt: Schema.Attribute.DateTime;
    salesNotificationEmails: Schema.Attribute.JSON;
    siteUrl: Schema.Attribute.String & Schema.Attribute.Required;
    socialLinks: Schema.Attribute.Component<'navigation.link', true>;
    titleTemplate: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'%s | Scribient'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
